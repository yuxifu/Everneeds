package com.yuxifu.everneeds.ui.products.todolist;
...
public class TodoWidgetFragment extends BaseProductWidgetFragment {
    ...
    public static TodoWidgetFragment newInstance(boolean isCollapsed) {
        TodoWidgetFragment fragment = new TodoWidgetFragment();
    ...
    protected int getIconResId(){
        return R.drawable.icons8_to_do_96;
    }
